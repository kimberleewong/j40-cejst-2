...
import {
  CONTACT_SURVEY_LINKS,
  DATA_SURVEY_LINKS,
  PAGES_ENDPOINTS,
  SITE_SATISFACTION_SURVEY_LINKS,
} from '../constants';
...
export const EJSCREEN =
  'https://www.epa.gov/ejscreen/how-does-epa-use-ejscreen';
export const WHEJAC_RECOMMENDATIONS =
  'https://www.epa.gov/environmentaljustice/white-house-environmental-justice-advisory-council';

export const CEJST_INSTRUCT =
  process.env.GATSBY_CDN_TILES_BASE_URL +
  `/data-versions/2.0/data/score/downloadable/CEQ-CEJST-Instructions.pdf`;
export const CEJST_INSTRUCT_ES =
  process.env.GATSBY_CDN_TILES_BASE_URL +
  `/data-versions/2.0/data/score/downloadable/CEQ-CEJST-Instructions-es.pdf`;

export const CEJST_MEMO = `https://www.whitehouse.gov/wp-content/uploads/2023/01/M-23-09_Signed_CEQ_CPO.pdf`;
export const CEJST_MEMO_ES =
  process.env.GATSBY_CDN_TILES_BASE_URL +
  `/data-versions/2.0/data/score/downloadable/M-23-09_Signed_CEQ_CPO_es.pdf`;
...
export const PAGE = defineMessages({
  TITLE: {
    ...
    description:
      'Navigate to the About page. This is the about page title text',
  },
});
...
export const HOW_TO_USE_TOOL = defineMessages({
  TITLE: {
    ...
    description:
      'Navigate to the About page. This is the sub heading of How to use the tool',
  },
  PARA2: {
    ...
    description:
      'Navigate to the About page. This is the sub heading of How to use the tool paragraph1',
  },
});
...
export const GET_INVOLVED = defineMessages({
  ...
  SEND_FEEDBACK_HEADING: {
    ...
    description:
      'Navigate to the About page. This is the sending feedback heading',
  },
  SEND_FEEDBACK_INFO: {
    ...
    `,
    description:
      'Navigate to the About page. This is the sending feedback information',
  },
  JOIN_OSC_HEADING: {
    id: 'about.page.join.opensource.heading',
    defaultMessage: 'Join the open source community',
    description:
      'Navigate to the About page. This is the join the community heading',
  },
  JOIN_OSC_INFO: {
  ...
  JOIN_OSC_LINK_TEXT: {
    ...
    description:
      'Navigate to the About page. This is the link to github repository',
  },
  JOIN_OSC_LINK_TAG: {
    id: 'about.page.join.open.source.link.tag',
    defaultMessage: 'New Location',
    description:
      'Tag shown next to GitHub links indicating it has a new location',
  },
});
...
export const ACKNOWLEDGEMENTS = defineMessages({
  TITLE: {
    ...
    description:
      'Navigate to the About page. This is the acknowledgements headingl',
  },
  PARA1: {
    id: 'acknowledgements.para1',
    defaultMessage: 'This is a placeholder for the acknowledgements paragraph',
    description:
      'Navigate to the About page. This is the subheading of acknowledgements',
  },
});
...
export const ACKNOWLEDGEMENTS_CONTENT = {
  PARA1: (
    <FormattedMessage
      ...
      description={
        'Navigate to the About page. This is the Acknowledgements paragraph'
      }
    />
  ),
};
